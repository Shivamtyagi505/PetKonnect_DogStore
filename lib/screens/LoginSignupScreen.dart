...
class _LoginSignupScreenState extends State<LoginSignupScreen> {
  ...
  storeLoginDataAndProceed(BuildContext context, String token) async {
          ...
          listener: (context, state) {
            if (state is LoginResState) {
              ...
              if (mLoginResponse.status) {
                saveUserPref(mLoginResponse.token.toString());
                storeLoginDataAndProceed(
                    context, mLoginResponse.token.toString());
              } else {
                            ...
                            mCurrentTab == "register"
                                ? ListView(
                                    ...
                                    children: [
                                      ...
                                      PasswordTextInputWithIconWidget(
                                          pwdController,
                                          true,
                                          TextInputType.text,
...
//                                  );
  ...
  onSubmit() {
    if (mCurrentTab == "register") {
      ...
      } else if (confPwdController.text.trim().isEmpty) {
        showSnakbar(_scaffoldKey, empty_conf_password);
      } else if (pwdController.text.trim() != confPwdController.text.trim()) {
  ...
  _showDialog(BuildContext context, String message) {
    BlurryDialog alert = BlurryDialog("Verify", message, continueCallBack);
    showDialog(
      context: context,
