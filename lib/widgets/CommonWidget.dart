      ...
      child: Row(
        children: [
                  ...
                  children: [
                    Expanded(
                      ...
                      child: FadeInImage.assetNetwork(
                        ...
                        image: widget.product.productImage[0],
                        fit: BoxFit.contain,
                          ...
                          children: [
                            Text(
                              ...
                              style: CommonStyles.getMontserratStyle(space_15,
                                  FontWeight.w600, CommonStyles.black),
                            ),
                            SizedBox(
                              height: space_5,
                            ),
                            Text(
                              widget.product.productBrand.toString(),
          ...
          GestureDetector(
            onTap: () {
              productId.clear();
              productId.add("\"" + widget.product.id + "\"");
...
class SearchTextInputWidget extends StatelessWidget {
  ...
  CommonBloc commonBloc;
  var token;
  SearchTextInputWidget(this.textEditingController, this.isPassword,
      this.textInputType, this.commonBloc, this.token);
...
class PasswordTextInputWithIconWidget extends StatefulWidget {
  TextEditingController textEditingController;
  bool isPassword;
  TextInputType textInputType;
  String iconname;
  ...
  PasswordTextInputWithIconWidget(this.textEditingController, this.isPassword,
      this.textInputType, this.iconname, this.hintText);

  @override
  _PasswordTextInputWithIconWidgetState createState() =>
      _PasswordTextInputWithIconWidgetState();
}

class _PasswordTextInputWithIconWidgetState
    extends State<PasswordTextInputWithIconWidget> {
  bool _isObscure = true;
  @override
  Widget build(BuildContext context) {
    return Row(
...
class ItemCardNoMarginWidget extends StatefulWidget {
  Vendors mVendors;
  var token;
  ItemCardNoMarginWidget(this.mVendors, this.token);
...
class ProductItemCardNoMarginWidget extends StatefulWidget {
  ...
  var vendorId;
  var token;
  ProductItemCardNoMarginWidget(this.mProducts, this.vendorId, this.token);
